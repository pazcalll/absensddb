...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-striped">
  ...
  <tr>
    ...
    <td><a href="?cat=akademik&page=editjurusan&id=<?php echo sha1($s['kode_kelas']); ?>">Edit</a> - <a href="?cat=akademik&page=jurusan&del=1&id=<?php echo sha1($s['kode_kelas']); ?>">Hapus</a></td>
  </tr>
  <?php
  }
  ?>
